            ...
            <div class="auth-box bg-light border-top border-secondary">
                <div id="loginform"><?php $lib->msg();?>
                    <div class="text-center p-t-20 p-b-20">
                        <span style="color: #000;font-size: 18px;">ARTISIANS DIRECTORY MANAGEMENT SYSTEM</span>
                    </div>
                    <!-- Form -->
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                 ...
                                 <div class="input-group mb-3">
                                    ...
                                    <select class="form-control form-control-lg" placeholder="Category" aria-label="Category" aria-describedby="basic-addon1" name="type" required>
                                                        <option value="">SELECT CATEGORY</option>
                                                        <option value="2">USER</option>
                                                        <option value="3">ARTISIANS</option>
                                                    </select>
                                </div>
