		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<div class="w3l-nav">
				<ul class="nav navbar-nav link-effect">
					...
					<li><a href="#gallery" class="scroll">Services</a></li>	
	...
	<div class="codecon_half">
				<div class="expSearchBox">
					<div class="expSearchFrom">
						...
						<input id="field" type="text" name="search" placeholder="Search here"/>
...
<div class="banner-slider">
					...
					<ul class="rslides" id="slider3">
						<li>
							<div class="w3l_banner_info">
								<h3>Welcome to ARTISIANS DIRECTORY MANAGEMENT System</h3>
								<p>Providing Efficient Services at all time.</p>
						...
						<li>
							<div class="w3l_banner_info">
								...
								<p>Always available to meet you needs..</p>					
								<div class="agileits_w3layouts_more menu__item">
									<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Learn More</a>
								</div>
							</div>
 ...
 <div class="gallery" id="gallery">
	<div class="container">
		<h3 class="w3l-title"><span>Our</span> ARTISIANS Services</h3>
