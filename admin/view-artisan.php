            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">ALL ARTISAN</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        <thead>
                                         ...
                                         <?php
                            $qt=$crud->displayAllSpecificWithOrder('user','type','3','id','desc');
                      ...
                      echo "<tr><td colspan='9'><center>No Artisan at the moment</center</td></tr>";
                    }
                    ?>
